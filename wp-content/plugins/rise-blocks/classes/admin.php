    ...
    class Rise_Blocks_Admin extends Rise_Blocks_Helper{
        ...
        */
        public static function admin_scripts() {
			$scripts = array(
                ...
                array(
                    ...
                    'style'    => 'dist/vendors/modal-video/css/modal-video.min.css',
                    'version'  => '2.4.1',
                    'minified' => false
                ),
                array(
                    'handler' => self::add_prefix( '%prefix-modal-video' ),
                    'script'   => 'dist/vendors/modal-video/js/jquery-modal-video.js',
                    'version' => '2.4.1',
                ),
                array(
    	...
    	public static function admin_pages(){
    	    ...
    	    add_menu_page( 
    	        'rise-blocks', 
    	        esc_html__( 'Rise Blocks', 'rise-blocks' ), 
    	        'manage_options', 
    	        self::$page_slug, 
    	        array( __CLASS__, 'template' ), 
    	        self::get_plugin_directory_uri() . '/dist/img/rise-icon.svg', 
    	        110
    	    );
    	}
